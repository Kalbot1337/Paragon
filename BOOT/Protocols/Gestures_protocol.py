...
'''
Gesture recognition system for the ARC system (dev)
'''
...
while(cap.isOpened()):
    ...
    if count_defects == 1:
        ...
        cv2.putText(img,"Starting Arc", (50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
        subprocess.call("gnome-terminal -x Arc", shell=True)
        time.sleep(3)
        ...
        cv2.putText(img,"please show a hand.", (50,50),\
